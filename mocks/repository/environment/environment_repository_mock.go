...
func (_m *EnvironmentRepositoryMock) GetForProject(ctx context.Context, tx repository.TxInterface, projectID uuid.UUID) ([]*ent.Environment, error) {
	...
	var r0 []*ent.Environment
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, repository.TxInterface, uuid.UUID) ([]*ent.Environment, error)); ok {
		return rf(ctx, tx, projectID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, repository.TxInterface, uuid.UUID) []*ent.Environment); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, repository.TxInterface, uuid.UUID) error); ok {
...
func (_e *EnvironmentRepositoryMock_Expecter) GetForProject(ctx interface{}, tx interface{}, projectID interface{}) *EnvironmentRepositoryMock_GetForProject_Call {
	return &EnvironmentRepositoryMock_GetForProject_Call{Call: _e.mock.On("GetForProject", ctx, tx, projectID)}
}
