...
func (_m *TeamRepositoryMock) GetAll(ctx context.Context) ([]*ent.Team, error) {
	...
	var r0 []*ent.Team
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]*ent.Team, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []*ent.Team); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_e *TeamRepositoryMock_Expecter) GetAll(ctx interface{}) *TeamRepositoryMock_GetAll_Call {
	return &TeamRepositoryMock_GetAll_Call{Call: _e.mock.On("GetAll", ctx)}
}
