...
func (_m *ProjectRepositoryMock) GetByTeam(ctx context.Context, teamID uuid.UUID, sortField models.SortByField, sortOrder models.SortOrder) ([]*ent.Project, error) {
	ret := _m.Called(ctx, teamID, sortField, sortOrder)
	...
	var r0 []*ent.Project
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, models.SortByField, models.SortOrder) ([]*ent.Project, error)); ok {
		return rf(ctx, teamID, sortField, sortOrder)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, models.SortByField, models.SortOrder) []*ent.Project); ok {
		r0 = rf(ctx, teamID, sortField, sortOrder)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*ent.Project)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, models.SortByField, models.SortOrder) error); ok {
		r1 = rf(ctx, teamID, sortField, sortOrder)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *ProjectRepositoryMock_Expecter) GetByTeam(ctx interface{}, teamID interface{}, sortField interface{}, sortOrder interface{}) *ProjectRepositoryMock_GetByTeam_Call {
	return &ProjectRepositoryMock_GetByTeam_Call{Call: _e.mock.On("GetByTeam", ctx, teamID, sortField, sortOrder)}
}

func (_c *ProjectRepositoryMock_GetByTeam_Call) Run(run func(ctx context.Context, teamID uuid.UUID, sortField models.SortByField, sortOrder models.SortOrder)) *ProjectRepositoryMock_GetByTeam_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID), args[2].(models.SortByField), args[3].(models.SortOrder))
	})
	return _c
}
...
func (_c *ProjectRepositoryMock_GetByTeam_Call) RunAndReturn(run func(context.Context, uuid.UUID, models.SortByField, models.SortOrder) ([]*ent.Project, error)) *ProjectRepositoryMock_GetByTeam_Call {
	_c.Call.Return(run)
	return _c
}
