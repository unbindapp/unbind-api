...
func (_m *ServiceRepositoryMock) GetByEnvironmentID(ctx context.Context, environmentID uuid.UUID, withLatestDeployment bool) ([]*ent.Service, error) {
	ret := _m.Called(ctx, environmentID, withLatestDeployment)
	...
	var r0 []*ent.Service
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool) ([]*ent.Service, error)); ok {
		return rf(ctx, environmentID, withLatestDeployment)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, bool) []*ent.Service); ok {
		r0 = rf(ctx, environmentID, withLatestDeployment)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*ent.Service)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, bool) error); ok {
		r1 = rf(ctx, environmentID, withLatestDeployment)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *ServiceRepositoryMock_Expecter) GetByEnvironmentID(ctx interface{}, environmentID interface{}, withLatestDeployment interface{}) *ServiceRepositoryMock_GetByEnvironmentID_Call {
	return &ServiceRepositoryMock_GetByEnvironmentID_Call{Call: _e.mock.On("GetByEnvironmentID", ctx, environmentID, withLatestDeployment)}
}
