...
func (pq *PermissionQuery) QueryGroups() *GroupQuery {
...
func (pq *PermissionQuery) WithGroups(opts ...func(*GroupQuery)) *PermissionQuery {
	query := (&GroupClient{config: pq.config}).Query()
...
func (pq *PermissionQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Group)) error {
