...
func init() {
	...
	serviceconfigDescReplicas := serviceconfigFields[13].Descriptor()
	...
	serviceconfigDescAutoDeploy := serviceconfigFields[14].Descriptor()
	...
	serviceconfigDescPublic := serviceconfigFields[16].Descriptor()
