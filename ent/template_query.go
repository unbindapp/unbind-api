...
func (tq *TemplateQuery) QueryServices() *ServiceQuery {
...
func (tq *TemplateQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (tq *TemplateQuery) WithServices(opts ...func(*ServiceQuery)) *TemplateQuery {
	query := (&ServiceClient{config: tq.config}).Query()
...
func (tq *TemplateQuery) loadServices(ctx context.Context, query *ServiceQuery, nodes []*Template, init func(*Template), assign func(*Template, *Service)) error {
