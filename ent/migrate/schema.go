...
var (
	...
	DeploymentsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"build-pending", "build-queued", "build-running", "build-succeeded", "build-cancelled", "build-failed", "active", "waiting", "crashing"}},
