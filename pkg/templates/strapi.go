		...
		Inputs: []schema.TemplateInput{
			{
				...
				Description: "The domain to use for the Strapi instance.",
				Required:    true,
			},
			{
				ID:   2,
				...
				Description: "Size of the storage for Strapi uploads.",
				Required:    true,
			...
			},
			{
				...
				Description: "Size of the storage for Strapi source code (APIs, components etc.).",
				Required:    true,
				Default:     utils.ToPtr("512Mi"),
			},
			{
				...
				Description: "Size of the storage for Strapi configuration files.",
				Required:    true,
