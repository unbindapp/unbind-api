...
func (self *ServiceService) GetServiceContainerStatuses(ctx context.Context, requesterUserID uuid.UUID, bearerToken string, teamID, projectID, environmentID, serviceID uuid.UUID) ([]k8s.PodContainerStatus, error) {
