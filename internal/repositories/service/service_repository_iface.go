...
type ServiceRepositoryInterface interface {
	...
	CreateConfig(ctx context.Context, tx repository.TxInterface, serviceID uuid.UUID, serviceType schema.ServiceType, builder schema.ServiceBuilder, provider *enum.Provider, framework *enum.Framework, gitBranch *string, port *int, host *string, replicas *int32, autoDeploy *bool, runCommand *string, public *bool, image *string) (*ent.ServiceConfig, error)
	// Update the service
